...
class Producto
{
    ...
    /**
     * @var \LibuBundle\Entity\Tipo
     *
     * @ORM\ManyToOne(targetEntity="LibuBundle\Entity\Tipo")
     * @ORM\JoinColumns({
     ...
     * Set tipo
     *
     * @param \LibuBundle\Entity\Tipo $tipo
     *
     * @return Producto
     */
    public function setTipo(\LibuBundle\Entity\Tipo $tipo = null)
    {
        $this->tipo = $tipo;
