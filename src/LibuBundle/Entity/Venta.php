...
class Venta
{
    ...
    /**
     * @var \LibuBundle\Entity\Cliente
     *
     * @ORM\ManyToOne(targetEntity="LibuBundle\Entity\Cliente")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \LibuBundle\Entity\Tematica
     *
     * @ORM\ManyToOne(targetEntity="LibuBundle\Entity\Tematica")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \LibuBundle\Entity\Responsable
     *
     * @ORM\ManyToOne(targetEntity="LibuBundle\Entity\Responsable")
     * @ORM\JoinColumns({
     ...
     * Set cliente
     *
     * @param \LibuBundle\Entity\Cliente $cliente
     *
     * @return Venta
     */
    public function setCliente(\LibuBundle\Entity\Cliente $cliente = null)
    {
     ...
     * Get cliente
     *
     * @return \LibuBundle\Entity\Cliente
     */
     ...
     * Set tematica
     *
     * @param \LibuBundle\Entity\Tematica $tematica
     *
     * @return Venta
     */
    public function setTematica(\LibuBundle\Entity\Tematica $tematica = null)
    {
     ...
     * Get tematica
     *
     * @return \LibuBundle\Entity\Tematica
     */
     ...
     * Set responsable
     *
     * @param \LibuBundle\Entity\Responsable $responsable
     *
     * @return Venta
     */
    public function setResponsable(\LibuBundle\Entity\Responsable $responsable = null)
    {
     ...
     * Get responsable
     *
     * @return \LibuBundle\Entity\Responsable
     */
